...
const PersonalProjects = () =>{
    return(
           <div id="PersonalProjectPage">
            <div className="inLine"><h1 className="vt">GradeMe</h1> <p className="proj-desc"> &nbsp;&nbsp;&nbsp;-&nbsp; Professor's grading assistant</p></div>
            ...
            <p className="intro">While working as a TA for Software Design class, I had to manually check a lot of student submissions.
                ...
                Next, I added Codellama AI for student code analysis.<a id="in-text-link" href="https://github.com/Poleron402/GradeMeApp" target="_blank">GradeMe</a> on GitHub! ⭐
            </p>

            <img src={demo}></img>
            <br></br>
            <hr></hr>
            <div className="inLine"><h1 className="vt">OtterMusic</h1> <p className="proj-desc"> &nbsp;&nbsp;&nbsp;-&nbsp; A web audio-editor with AI</p></div>
